...
public class AveragePriceOfInstrumentExtractorTest extends AbstractSparkUnitTest {
    private Rfq rfq;
    ...
    @Test
    public void checkAveragePriceWhenInstrumentMatch() {
...
//        assertEquals(138.4396, result);
    ...
    @Test
    public void checkAveragePriceWhenNoInstrumentMatch() {
